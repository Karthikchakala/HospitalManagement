...
export default function DispensaryManagementPage() {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            ...
            try {
                ...
                const apptResponse = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/api/staff/pharmacy/pending`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                setPendingAppointments(apptResponse.data);

                const medResponse = await axios.get(`${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/api/staff/pharmacy/medicines`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
    ...
    const handleDispense = async (e: React.FormEvent) => {
        ...
        try {
            await axios.put(`${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}/api/staff/pharmacy/dispense/${selectedAppt.appointment_id}`, {
