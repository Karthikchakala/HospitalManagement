...
const API_BASE = process.env.NEXT_PUBLIC_API_BASE || process.env.NEXT_PUBLIC_BACKEND_BASE_URL;
...
export default function VideoRoomPage() {
  ...
  const pollAnswer = React.useCallback(async (pc: RTCPeerConnection) => {
    let tries = 0;
    while (tries < 60) { // ~60s
